...
{
    public MyPlatformContext()
    {
    }

    public MyPlatformContext(DbContextOptions<MyPlatformContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("Host=localhost;Database=my_platform;Username=admin;Password=admin123");
